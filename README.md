...
**Download** example build [**from Releases**](https://github.com/danilw/vulkan-shader-launcher/releases/tag/rel_1_1). 

~~Minimal binary build size, after upx compression, \~30kb (without built-in shaders in *example_minimal*). Using [yari-v](https://github.com/sheredom/yari-v) to compress shaders, in *example_fbo* size of bin(exe) with shaders \~50Kb.~~ 
