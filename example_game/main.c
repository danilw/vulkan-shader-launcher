...
{                    // to avoid 128bytes limit maxPushConstantsSize removed unused data
...
void update_push_constants(struct shaders_uniforms *push_constants, struct app_os_window *os_window, int id,
                           float *p_pos)
{
