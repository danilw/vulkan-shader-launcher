...
static vk_error init_texture(struct vk_physical_device *phy_dev, struct vk_device *dev,
                             struct vk_render_essentials *essentials, struct vk_image *image, const char *name)
{
    ...
    *image = (struct vk_image){
    ...
    retval = vk_render_init_texture(phy_dev, dev, essentials, image, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL,
                                    generated_texture, name);
